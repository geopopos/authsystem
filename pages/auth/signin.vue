  ...
  <UCard class="max-w-sm w-full">
    ...
    >
      <template #description>
        Don't have an account? <NuxtLink to="/auth/signup" class="text-primary font-medium">Sign up</NuxtLink>.
      </template>

      <template #password-hint>
        <NuxtLink to="/auth/forgotpassword" class="text-primary font-medium">Forgot password?</NuxtLink>
      </template>
